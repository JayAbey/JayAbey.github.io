...
var MasonryComponent = {
  ...
  render: function (createElement) {
    ...
    var columns = [];
    var isGutterSizePlainValue = parseInt(this.displayGutter) === this.displayGutter * 1;
    var gutterSize =  isGutterSizePlainValue ? (this.displayGutter + 'px') : this.displayGutter;
